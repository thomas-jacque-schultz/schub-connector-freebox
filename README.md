...
| | |
|---|---|
| Paquet racine | `schultz.thomas.schub.connector.freebox` |
| Image Docker | `thomasschultzschub/schub-connector-freebox` |
| Port en dev | 18084 (vers 8080 dans le conteneur) |
...
avec les sources en volume : `task dev` depuis ce dossier, puis `task logs -- schub-connector-freebox`.
